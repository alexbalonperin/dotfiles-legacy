...
module Config
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/abalonperin/dotfiles/rvm/rvm/rubies/ruby-1.8.7-head' '--without-tcl' '--without-tk' '--disable-install-doc' '--enable-shared' 'CC=/usr/local/bin/gcc-4.2' 'CFLAGS=-O3 -I/usr/local/opt/libyaml/include -I/usr/local/opt/readline/include -I/usr/local/opt/libksba/include -I/usr/local/opt/openssl098/include' 'LDFLAGS=-L/usr/local/opt/libyaml/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/libksba/lib -L/usr/local/opt/openssl098/lib'"
