...
module Config
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.8/i686-darwin13.0.2")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/abalonperin/.rvm/rubies/ruby-1.8.7-p374")
  CONFIG["ruby_install_name"] = "ruby"
  CONFIG["RUBY_INSTALL_NAME"] = "ruby"
  CONFIG["RUBY_SO_NAME"] = "ruby"
  CONFIG["MANTYPE"] = "doc"
  CONFIG["NROFF"] = "/usr/bin/nroff"
  CONFIG["configure_args"] = " '--prefix=/Users/abalonperin/.rvm/rubies/ruby-1.8.7-p374' '--without-tcl' '--without-tk' '--enable-shared' 'CC=/usr/local/bin/gcc-4.2' 'CFLAGS=-O3 -I/usr/local/opt/libyaml/include -I/usr/local/opt/readline/include -I/usr/local/opt/libksba/include -I/usr/local/opt/openssl098/include' 'LDFLAGS=-L/usr/local/opt/libyaml/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/libksba/lib -L/usr/local/opt/openssl098/lib'"
  CONFIG["vendordir"] = "$(libdir)/ruby/vendor_ruby"
  CONFIG["sitedir"] = "$(libdir)/ruby/site_ruby"
  CONFIG["sitearch"] = "i686-darwin13.0.2"
  CONFIG["arch"] = "i686-darwin13.0.2"
  ...
  CONFIG["CPP"] = "/usr/local/bin/gcc-4.2 -E"
  CONFIG["OBJEXT"] = "o"
  ...
  CONFIG["CC"] = "/usr/local/bin/gcc-4.2"
  CONFIG["target_os"] = "darwin13.0.2"
  CONFIG["target_vendor"] = "apple"
  CONFIG["target_cpu"] = "i686"
  CONFIG["target"] = "i686-apple-darwin13.0.2"
  CONFIG["host_os"] = "darwin13.0.2"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "i686"
  CONFIG["host"] = "i686-apple-darwin13.0.2"
  CONFIG["build_os"] = "darwin13.0.2"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "i686"
  CONFIG["build"] = "i686-apple-darwin13.0.2"
  CONFIG["TEENY"] = "7"
  CONFIG["MINOR"] = "8"
  CONFIG["MAJOR"] = "1"
  CONFIG["target_alias"] = ""
