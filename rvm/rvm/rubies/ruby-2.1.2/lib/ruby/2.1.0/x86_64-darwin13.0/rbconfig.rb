...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/travis/.rvm/rubies/ruby-2.1.2")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/travis/.rvm/rubies/ruby-2.1.2' '--enable-load-relative' '--with-static-linked-ext' '--without-ext=dl/win32,fiddle/win32,tk/tkutil,tk,win32ole,-test-/win32/dln,-test-/win32/fd_setsize' '--sysconfdir=/etc' '--disable-install-doc' '--disable-shared' '--with-arch=x86_64' 'CC=gcc' 'CFLAGS=-O3 -I/Users/travis/.sm/pkg/active/include -fPIC -mmacosx-version-min=10.7' 'LDFLAGS=-L/Users/travis/.sm/pkg/active/lib -fPIC -Bstatic'"
  ...
  CONFIG["LDFLAGS"] = "-L. -L/Users/travis/.sm/pkg/active/lib -fPIC -Bstatic -fstack-protector"
  CONFIG["CFLAGS"] = "-O3 -I/Users/travis/.sm/pkg/active/include -fPIC -mmacosx-version-min=10.7 -pipe"
  CONFIG["CC"] = "gcc"
